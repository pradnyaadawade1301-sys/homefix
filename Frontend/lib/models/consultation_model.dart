...
class Consultation {
  ...
  factory Consultation.fromJson(Map<String, dynamic> json) {
    return Consultation(
      ...
      startTime: json['started_at'] != null ? DateTime.tryParse(json['started_at'] as String) : null,
      endTime: json['ended_at'] != null ? DateTime.tryParse(json['ended_at'] as String) : null,
